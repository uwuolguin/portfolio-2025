...
@pytest.mark.asyncio
async def test_orphan_image_detection_and_cleanup():  # pylint: disable=too-many-locals
    """
    ...
    try:
        ...
        print("✓ Image exists in storage service")
        ...
        async with get_conn() as conn:
            ...
            """)
            db_images = {f"{row['image_url']}{row['image_extension']}" for row in rows}
        ...
        print("✓ Image correctly not referenced in database (orphan)")
        ...
        print("✓ Image correctly detected as orphan")
        ...
        print("✓ Orphan image deleted successfully")
        ...
        print("✓ Verified image no longer exists in storage")
        print("\n✓ Orphan image cleanup test passed!")

    except Exception as e:  # pylint: disable=broad-exception-caught
        # Cleanup on failure — best-effort, ignore secondary errors
        try:
