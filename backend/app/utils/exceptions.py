...
def derive_error_code(status_code: int) -> str:
    """Derive error code string from an HTTP status code."""
...
class APIError(Exception):
    ...
    def __init__(
        ...
        self.error_code = error_code or derive_error_code(status_code)
...
async def http_exception_handler(
    ...
    error_code = derive_error_code(exc.status_code)
