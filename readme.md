...
- Inline documentation: going through every manifest and script to add comments explaining what each piece does and why, so terms like gzip, boltdb, TSDB, or any config value make sense in place without googling.
