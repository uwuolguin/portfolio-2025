...
│   ├── 09-backend.yaml
│   └── 10-nginx.yaml
└── .credentials               # Generated secrets (git-ignored)
```
...
✅ 2x Image Service replicas with automatic load balancing
✅ 2x Backend replicas with rolling updates
